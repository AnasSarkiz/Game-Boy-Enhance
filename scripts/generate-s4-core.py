...
def main():
    ...
    for net in nets:
        flags = " isGroundNet" if net["name"] == "GND" else " isPowerNet" if net["reference_net"] in ["+0V9", "+1V5", "+1V8", "+3V3", "VBUS", "Net-(U4-VBUS)"] else ""
    ...
    manifest = {"scope": "power_cpu_usb_storage_recovery_controls_stage", "components": components, "nets": nets,
