...
export const A_2N7002LT1G = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      symbol={
        <symbol>
          <schematicpath points={[{"x":0.08,"y":0},{"x":0.2,"y":-0.04},{"x":0.2,"y":0.04},{"x":0.08,"y":0}]} strokeColor="#880000" isFilled fillColor="#000000" />
          <schematicpath points={[{"x":0.4,"y":0.06},{"x":0.34,"y":-0.04},{"x":0.46,"y":-0.04},{"x":0.4,"y":0.06}]} strokeColor="#880000" isFilled fillColor="#FEFEFE" />
          ...
          <schematicpath points={[{"x":0.2,"y":-0.14},{"x":0,"y":-0.14}]} strokeColor="#880000" />
          <schematicpath points={[{"x":-0.04,"y":0.2},{"x":-0.04,"y":-0.2}]} strokeColor="#880000" />
          ...
          <schematicpath points={[{"x":-0.2,"y":-0.2},{"x":-0.04,"y":-0.2}]} strokeColor="#880000" />
          <schematicpath points={[{"x":0.46,"y":0.06},{"x":0.44,"y":0.06},{"x":0.36,"y":0.06},{"x":0.34,"y":0.06}]} strokeColor="#880000" />
          <port name="pin3" pinNumber={3} aliases={["D"]} direction="up" schX={0.2} schY={0.4} schStemLength={0.2} />
          <port name="pin1" pinNumber={1} aliases={["G"]} direction="left" schX={-0.4} schY={-0.2} schStemLength={0.2} />
  ...
  "jlcpcb": [
    "C16338"
      ...
      manufacturerPartNumber="2N7002LT1G"
      footprint={<footprint>
...
<courtyardoutline outline={[{"x":-1.8947769999999906,"y":1.74606},{"x":2.161223000000021,"y":1.74606},{"x":2.161223000000021,"y":-1.7511400000000066},{"x":-1.8947769999999906,"y":-1.7511400000000066},{"x":-1.8947769999999906,"y":1.74606}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C16338.obj?uuid=d777607a152f4f3aac9bb0d0c14ed6fd",
        stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C16338.step?uuid=d777607a152f4f3aac9bb0d0c14ed6fd",
