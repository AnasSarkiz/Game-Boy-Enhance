...
export const MMBT3904LT1G = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      symbol={
        <symbol>
          <port name="pin1" pinNumber={1} aliases={["1"]} direction="left" schX={-0.2} schY={0} schStemLength={0.2} />
          <port name="pin3" pinNumber={3} aliases={["3"]} direction="up" schX={0.2} schY={0.4} schStemLength={0.2} />
          <port name="pin2" pinNumber={2} aliases={["2"]} direction="down" schX={0.2} schY={-0.4} schStemLength={0.2} />
...
<courtyardoutline outline={[{"x":-2.0281269999999267,"y":1.774000000000001},{"x":2.0024730000002364,"y":1.774000000000001},{"x":2.0024730000002364,"y":-1.7993999999999915},{"x":-2.0281269999999267,"y":-1.7993999999999915},{"x":-2.0281269999999267,"y":1.774000000000001}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C81464.obj?uuid=cefd4596db214da394d9632b2b88f8f2",
        stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C81464.step?uuid=cefd4596db214da394d9632b2b88f8f2",
