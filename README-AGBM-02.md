# Historical AGBM-02 adaptation

Archived before the tabletop-console scope change. These notes and commands describe historical work; use the main README for the active design. The circuit is now `agbm-02.circuit.tsx`.
